...
class OePythondebugActor(OeBaseActor):
    name = "OePythondebugActor"
    description = "Test the python-debug command of the openEuler system."
    sh_file = '99_miscellaneous/oe_test39_python-debug.sh'